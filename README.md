...
Dette er en komplett statisk førsteversjon for Musta Digital.

Åpne `index.html` i nettleseren for å se siden. Filene kan også lastes opp til et vanlig webhotell, Netlify, Vercel eller GitHub Pages.
...
- `script.js` - mobilmeny og kontaktskjema via e-post
